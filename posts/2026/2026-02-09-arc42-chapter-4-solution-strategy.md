...
Chapter 4 is where those inputs start to shape the design.
Here you set direction for the solution.
...
The strategy grows as you learn, as constraints become concrete, and as decisions are recorded (often as ADRs).
...
- Links to ADRs when they exist (usually chapter 9 later).

What does not belong here:

- Detailed building block structure (chapter 5).
- Runtime sequencing and flows (chapter 6).
- Deployment details (chapter 7).
- Low-level technical decisions that (could) change often (those belong in ADRs or later chapters).
- Repeating large parts of chapters [1][CH1] to [3][CH3] (link instead).
...
- 3–7 strategy statements
- each includes:
  - the decision or approach (one line)
  - the rationale (one or two lines)
  - the main consequences/impact (one or two lines)
  - links to the relevant driver(s) (chapter [1][CH1]), constraint(s) (chapter [2][CH2]), or context item(s) (chapter [3][CH3])

That is enough to align a team and stop people from designing in different directions.
